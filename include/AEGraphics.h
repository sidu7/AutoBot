 ...
 * @param tu0 Horizontal tetxure coordinate
 ...
 * @param tu1 Horizontal tetxure coordinate
 * @param tv1 Vertical texture description
 ...
 * @param tu2 Horizontal tetxure coordinate
 * @param tv2 Vertical texture description
 */
